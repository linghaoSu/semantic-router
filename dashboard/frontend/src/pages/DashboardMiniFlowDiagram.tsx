...
import styles from "./DashboardMiniFlowDiagram.module.css"
...
export const DashboardMiniFlowDiagram: React.FC<FlowProps> = React.memo(({ signals, decisions, models, plugins }) => {
