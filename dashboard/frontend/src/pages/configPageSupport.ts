...
export const listInputToArray = (input: string): string[] =>
  input
    .split(/[\n,]/)
    .map((item) => item.trim())
    .filter(Boolean)

export const removeSignalByName = (cfg: ConfigData, type: SignalType, targetName: string): void => {
...
export const removeDecisionByName = (cfg: ConfigData, targetName: string): void => {
